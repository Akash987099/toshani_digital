...
?>
    ...
    <header id="header" class="py-28 text-center lg:text-left">
      ...
      >
        <div class="xl:mr-12">
          <p class="p-title font-bold"><strong>Aws Connect INDIA</strong></p>
        ...
        <div class="xl:text-right">
          <img class="inline" src="icon/icon logo/img/about_us.png" alt="alternative" />
        </div>
      </div>
      <!-- end of container -->
    </header>
        ...
        <div class="lg:col-span-6">
          <div class="xl:ml-14">
            <img
              class="inline"
              width="500"
              src="images/Multifunctional-Kiosk.jpg"
              alt="alternative"
            />
          </div>
        </div>
