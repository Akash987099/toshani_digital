            ...
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
                ...
                <div class="lg:col-span-5">
                    <div class="xl:mt-12">
                        ...
                        <a class="btn-solid-reg popup-with-move-anim mr-1.5" href="service.php-lightbox">Lightbox</a>
                        <a class="btn-outline-reg" href="article.php">Details</a>
                    </div>
                </div> <!-- end of col -->
            </div> <!-- end of container -->
        </div>
        ...
        <div id="details-lightbox" class="lightbox-basic zoom-anim-dialog mfp-hide">
            <div class="lg:grid lg:grid-cols-12 lg:gap-x-8">
                ...
                <div class="lg:col-span-4">
                    ...
                    <a class="btn-solid-reg mfp-close page-scroll" href="career.php">Download</a>
